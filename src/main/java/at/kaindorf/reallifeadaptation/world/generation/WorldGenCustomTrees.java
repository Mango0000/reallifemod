package at.kaindorf.reallifeadaptation.world.generation;
...
{
    private final WorldGenerator COPPER = new WorldGenRubberTree();
    ...
    public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider)
    {
        switch(world.provider.getDimension())
        {
            ...
            case 0:
                ...
                runGenerator(COPPER, world, random, chunkX, chunkZ, 5, CommonProxy.COPPER_DIRT, BiomeCopper.class);
                break;
