...
public class GuiGeneratorUpgrade extends GuiContainer {
    ...
    private final TileEntityGeneratorUpgrade tileentity;

    public GuiGeneratorUpgrade(InventoryPlayer player, TileEntityGeneratorUpgrade tileentity)
    {
        super(new ContainerGeneratorUpgrade(player, tileentity));
        this.player = player;
...
//        this.drawTexturedModalRect(this.guiLeft + 44, this.guiTop + 36, 176, 14, l + 1, 16);
        if (TileEntityGeneratorUpgrade.isBurning(tileentity))
        {
            int k = this.getBurnLeftScaled(13);
