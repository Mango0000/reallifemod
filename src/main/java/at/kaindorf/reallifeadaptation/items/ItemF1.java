...
public class ItemF1 extends Item
{
    private final EntityF1.Type type;

    public ItemF1(EntityF1.Type typeIn, String name)
    {
        this.type = typeIn;
        this.maxStackSize = 1;
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                EntityF1 entityboat = new EntityF1(worldIn, raytraceresult.hitVec.x, flag1 ? raytraceresult.hitVec.y - 0.12D : raytraceresult.hitVec.y, raytraceresult.hitVec.z);
