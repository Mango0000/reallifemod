package at.kaindorf.reallifeadaptation.world.generation.generators;
...
public class WorldGenRubberTree extends WorldGenAbstractTree {
    public static final IBlockState LOG = CommonProxy.COPPER_LOG.getDefaultState();
    public static final IBlockState LEAF = CommonProxy.COPPER_LEAVES.getDefaultState();
    ...
    protected boolean canGrowInto(Block blockType)
    {
        ...
        return material == Material.AIR || material == Material.LEAVES || material == Material.GROUND || blockType == CommonProxy.COPPER_DIRT || blockType == Blocks.GRASS || blockType == Blocks.DIRT || blockType == Blocks.LOG || blockType == Blocks.LOG2 || blockType == Blocks.SAPLING || blockType == Blocks.VINE;
