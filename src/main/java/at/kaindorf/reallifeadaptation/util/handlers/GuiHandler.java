...
import at.kaindorf.reallifeadaptation.guis.GuiHochofen;
...
public class GuiHandler implements IGuiHandler {
    ...
    public Object getServerGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z)
    {
        ...
        if(ID == 4) return new ContainerHochofen(player.inventory, (TileEntityHochofen) world.getTileEntity(new BlockPos(x,y,z)));
        return null;
    }
    ...
    public Object getClientGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z)
    {
        ...
        if(ID == 4) return new GuiHochofen(player.inventory, (TileEntityHochofen) world.getTileEntity(new BlockPos(x,y,z)));
        return null;
    }
}
